...
export const BOSSES: Boss[] = [
    ...
    { id: "lord_of_the_death", name: "Lord of The Death", type: "MVP" },
    ...
    { id: "naght_sieger", name: "Naght Sieger", type: "Mini" },
    { id: "coelacant", name: "Coelacant", type: "Mini" },
    ...
    { id: "sorcerer_celia", name: "Sorcerer Celia", type: "Mini" },
]